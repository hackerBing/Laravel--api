...
Route::namespace('Api')->middleware(['api.auth.token'])->group(function () {
    ...
    {
        // 获取在线用户
        Route::post('/getHomeOnlineUserList', 'UserController@onlineUserList');
        // 强退用户登录
        Route::post('/logoutHomeOnlineUser', 'UserController@logoutHomeOnlineUser');

        // 获取用户列表
        Route::post('/getHomeUserList', 'UserController@HomeUserList');

        // 修改用户信息

        Route::post('/editHomeUserList', 'UserController@editHomeUserList');


        // 修改密码
        Route::post('/editHomeUserPass', 'UserController@editHomeUserPass');
        // 删除用户
        Route::post('/deleteHomeUserList', 'UserController@deleteHomeUserList');
